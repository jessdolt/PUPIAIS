...
<body id="<?php echo $_SESSION['user_type']?>">
    <header class="mainHeader <?php echo ($url[0] == 'survey_widget') ? 'userSurvey': '';?><?php echo ($url[1] == 'editProfile' && $data['accInfo']->verify != "YES") ? 'userSurvey firstEdit' : '';?><?php echo ($url[1] == 'profileAdditionalAdd') ? ' userSurvey' : '';?>">
