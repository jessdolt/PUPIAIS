                        ...
                        <div class="album-list" id="parent-album" >
                            ...
                            <div class="album-con">
                                <div class="album-cover">
                                    <div class="option">
                                        <button type="button" class="btnDeleteInline" data-url="<?php echo URLROOT;?>/galleries/deleteImage/<?php echo $image->id?>/<?php echo $data['gallery']->id?>">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="album-body" data-img-id="<?php echo $image->id?>">
                                    <div class="input set-description" role="textbox" maxlength="200" contenteditable><?php echo $image->description?></div>
                                </div>
                            </div>
                            <?php endforeach;?>
                        </div>
                    ...
                    <div class="form">
                        ...
                        <div class="input-container">
                            ...
                            <div class="textFieldContainer">
                                <input type="text" name="albumName" id="gallery-title"  value="<?php echo $data['gallery']->gallery_title?>" required>
                            ...
                            <input type="hidden" value="<?php echo $data['gallery']->id?>" id="gallery-id">
