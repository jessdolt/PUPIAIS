...
<main class="admin news">
                ...
                <form class="table-form" id="page-form" action="<?php echo URLROOT?>/posts/delete" method="POST">
                    <table class="data-table">
                        ...
                        <?php foreach($data['news'] as $post): ?>
                            <tr>
                                ...
                                <td><img src="<?php echo URLROOT; ?>/uploads/<?php echo $post->image; ?>" alt="Content-Image"></td>
                                <td><p class="title"><?php echo $post->title ?></p></td>
                                <td><p class="Author"><?php echo $post->author ?></p></td>
                                <td><p class="Description"><?php echo strip_tags($post->description) ?></p></td>
...
<<<<<<< HEAD
                                        <a href="<?php echo URLROOT;?>/posts/single/<?php echo $post->id?>">View</a>
=======
                                        <a href="<?php echo URLROOT ?>/posts/single/<?php echo $post->id?>">View</a>
>>>>>>> 3cb4c99bc1e9cd135e5c5ffc115e47cfba593c01
                                        ...
                                        <button type="button" class="btnDeleteInline" data-id="<?php echo $post->id ?>" data-url="<?php echo URLROOT; ?>/posts/deleteRow">
                    ...
                    <div class="pagination">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/news<?php echo $data['first'] ?>" class="start">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/news<?php echo $data['previous'] ?>" class="previous">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/news<?php echo $data['next'] ?>" class="next">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/news<?php echo $data['last'] ?>" class="end">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
