                ...
                <section class="mainContent">
                    <form action="<?php echo URLROOT;?>/surveys/delete" class="table-form" method="POST">
                        ...
                        <div class="pagination">
                            ...
                            <a href="<?php echo URLROOT; ?>/admin/survey_list<?php echo $navigate['first'] ?>" class="start">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="<?php echo URLROOT; ?>/admin/survey_list<?php echo $navigate['previous'] ?>" class="previous">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="<?php echo URLROOT; ?>/admin/survey_list<?php echo $navigate['next'] ?>" class="next">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="<?php echo URLROOT; ?>/admin/survey_list<?php echo $navigate['last'] ?>" class="end">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
