...
>>>>>>> 3cb4c99bc1e9cd135e5c5ffc115e47cfba593c01
                    ...
                    <div class="pagination">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $data['first'] ?>" class="start">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $data['previous'] ?>" class="previous">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $data['next'] ?>" class="next">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $data['last'] ?>" class="end">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
