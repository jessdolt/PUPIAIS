            ...
            <main class="admin events">
                ...
                <form class="table-form" id="page-form" action="<?php echo URLROOT;?>/events/delete" method="POST">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><p class="title" style="text-align:center"><?php echo $event->title?></p></td>
                                <td><p class="Description"><?php echo $event->description?></p></td>
                                ...
                                <td><div class="option icon" tabindex="0">
                                    ...
                                    <div class="optionModal">
                                        ...
                                        <button type="button" class="btnDeleteInline" data-id="<?php echo $event->id?>" data-url="<?php echo URLROOT?>/events/deleteRow">
                    ...
                    <div class="pagination">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $navigate['first'] ?>" class="start">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $navigate['previous'] ?>" class="previous">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $navigate['next'] ?>" class="next">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/events<?php echo $navigate['last'] ?>" class="end">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
