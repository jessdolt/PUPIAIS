<?php require APPROOT . '/views/inc/header_admin.php';?>
    <section class="filterNav">
                <div class="btnContainer">
                    <a href="addNewGroup.html" class="addNewGroup">
                        New Group
                    ...
                    <button class="allUser">
                        All Users 
                        <span class="allUserCount">255</span>
                    </button>
                </div>
                <ul class="groupList">
                    <li class="group">
    ...
    <main class="Admin">
                <section class="pageSpecificHeader">
                    <div>
                        <h2>
                            <span class="department">DICT</span>
                        ...
                        <div class="btnContainer">
                            ...
                            <a href="userList.pdf" download="userList.pdf">
                                import
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><p class="studentID">2018-12164-MN-0</p></td>
                                <td><p class="studentName">Lawrence Anthony De Vera Ferrer</p></td>
                                <td><p class="studentEmail">lawrence.anthony.ferrer@gmail.com </p></td>
                                <td><p class="gender">Male</p></td>
                                <td><p class="course">DICT</p></td>
                                <td><p class="batch">Male</p></td>
