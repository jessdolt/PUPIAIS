...
<main class="admin jobPortal">
                ...
                <form class="table-form" id="page-form" action="<?php echo URLROOT;?>/job_portals/delete" method="POST">
                    ...
                    <div class="pagination">
                        ...
                        <span class="currentRows"><?php echo $navigate['start'] . '-' . $navigate['limit'] . ' of ' . $navigate['total']?></span>
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $navigate['first'] ?>" class="start">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $navigate['previous'] ?>" class="previous">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $navigate['next'] ?>" class="next">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $navigate['last'] ?>" class="end">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
