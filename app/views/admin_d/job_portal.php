...
<main class="admin jobPortal">
                ...
                <form class="table-form" id="page-form" action="<?php echo URLROOT;?>/job_portals/delete" method="POST">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><p class="status <?php echo ($job->job_status == 'Active') ? 'open' : 'closed' ?>"><?php echo $job->job_status?></p></td>
                                <td><p class="workType <?php echo ($job->work_status == 'Full-Time') ? 'fullTime' : 'partTime' ?>"><?php echo $job->work_status?></p></td>
                                <td><p class="jobTitle"><?php echo $job->job_title?></p></td>
                                <td><p class="company"><?php echo $job->company_name?></p></td>
                                <td><p class="description"><?php echo strip_tags($job->description)?></p></td>
                                <td><time datetime="0000-09-02"><?php echo date('F j' .','. ' Y ', strtotime($job->posted_on))?></time></td>
                                <td><div class="option" tabindex="0">
                                    <span class="optionSpan icon">&#8942</span>
                                    <div class="optionModal">
<<<<<<< HEAD
                                        <a href="<?php echo URLROOT;?>/job_portals/single/<?php echo $job->id?>">View</a>
=======
                                        <a href="<?php echo URLROOT ?>/job_portals/single/<?php echo $job->id?>">View</a>
>>>>>>> 3cb4c99bc1e9cd135e5c5ffc115e47cfba593c01
                                        <a href="<?php echo URLROOT;?>/job_portals/edit/<?php echo $job->id?>">
                                        ...
                                        <button type="button" data-id="<?php echo $job->id?>" data-url="<?php echo URLROOT?>/job_portals/deleteRow" class="btnDeleteInline">
                    ...
                    <div class="pagination">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $data['first'] ?>" class="start">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $data['previous'] ?>" class="previous">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $data['next'] ?>" class="next">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/job_portal<?php echo $data['last'] ?>" class="end">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
