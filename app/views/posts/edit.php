                ...
                <form action="<?php echo URLROOT;?>/posts/edit/<?php echo $data['id'];?>" method="POST" enctype="multipart/form-data">
                    <div class="form">
                        ...
                        <div class="textFieldContainer">
                            <input type="text" name="title" id="news-title" value="<?php echo $data['title']?>" required>
                            <span class="error"></span>
                        </div>
                        <label for="author-name" class="outsideLabel">Author:</label>
                        <div class="textFieldContainer">
                            <input type="text" name="author" id="author-name" value="<?php echo $data['author']?>" required>
                            <span class="error"></span>
                        </div>
                    ...
                    <div class="form">
                        <a href="<?php echo URLROOT;?>/admin/news" class="closeIcon">
