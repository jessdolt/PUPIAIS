    ...
    <main class="admin newsAdd dataInput">
                ...
                <section class="mainContent adminForm">
                    <form action="<?php echo URLROOT;?>/events/add" method="POST" enctype="multipart/form-data">
                        <div class="form">
                            <h2>Content > Events > Add</h2>
                            <h3>primary details:</h3>
                            <label for="events-title" class="outsideLabel">Events Title:</label>
                            <div class="textFieldContainer">
                                <input type="text" name="title" id="events-title"required >
                                <span class="error"></span>
                            </div>
                            <label for="description" class="outsideLabel">Description:</label>
                            <div class="richTfContainer" style="border: none;">
                                    <textarea name="description" id="" cols="20" rows="20" style="width: 100%; font-size: 1.4rem;padding: .8rem"></textarea>
                            </div>
                        </div>
                        <div class="form">
                            <a href="events.html" class="closeIcon">
