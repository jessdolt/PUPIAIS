<?php require APPROOT . '/views/inc/header_admin.php';?>
    <main class="admin newsAdd dataInput">
                ...
                <section class="mainContent adminForm">
                    <form action="<?php echo URLROOT;?>/events/edit/<?php echo $data['id']?>" method="POST" enctype="multipart/form-data">
                        <div class="form">
                            ...
                            <h2>Content > Events > Edit</h2>
                            <h3>primary details:</h3>
                            <label for="events-title" class="outsideLabel">Events Title:</label>
                            <div class="textFieldContainer">
                                <input type="text" name="title" id="events-title"required value="<?php echo $data['title']?>" >
                                <span class="error"></span>
                            </div>
                            <label for="description" class="outsideLabel">Description:</label>
                            <div class="richTfContainer" style="border: none;">
                                    <textarea name="description" id="" cols="20" rows="20" style="width: 100%; font-size: 1.4rem;padding: .8rem"> <?php echo $data['description']?>
                                    </textarea>
                            </div>
                        </div>
                        <div class="form">
                            <a href="<?php echo URLROOT;?>/admin/events" class="closeIcon">
                            ...
                            <div class="btnGroupContainer">
                                ...
                                <button class="save" type='submit' name="submit">
                                    <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
