                ...
                <form action="<?php echo URLROOT; ?>/profile/editProfile/<?php echo $data['student_no']?>" method="POST" class="form" enctype="multipart/form-data">
                    ...
                    <div class="questionCon">
                        ...
                        <?php if (empty($data['file'])) { ?>
                            <img class="profilePic" src="<?php echo URLROOT ?>/images/default-profile-picture.png" width="200" height="200">
                        <?php } else { ?>
                            <img class="profilePic" src="<?php echo URLROOT ?>/uploads/<?php echo $data['file']?>" width="200" height="200">
                        <?php } ?>
                            ...
                            <input type="file" id="profile-pic-btn">
                        </div>
